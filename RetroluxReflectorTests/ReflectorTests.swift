...
class RetroluxReflectorTests: XCTestCase {
    ...
    func testSetProperty() {
        ...
        do {
            ...
            XCTAssert(properties.last?.type == PropertyType.optional(wrapped: .transformable(transformer: ReflectableTransformer(), targetType: Test.self)))
    ...
    func testNestedInDictionary() {
        ...
        do {
            ...
            XCTAssert(properties.last?.name == "nested")
            XCTAssert(properties.last?.type == PropertyType.dictionary(type: PropertyType.transformable(transformer: ReflectableTransformer(), targetType: Test.self)))
    ...
    func testNestedArrayAndDictionary() {
        ...
        do {
            ...
            XCTAssert(properties.count == 2)
            XCTAssert(properties.last?.name == "nested")
            XCTAssert(properties.last?.type == PropertyType.array(type: PropertyType.dictionary(type: PropertyType.transformable(transformer: ReflectableTransformer(), targetType: Test.self))))
    ...
    func testNullable() {
        class Test: NSObject, Reflectable {
            ...
            static let transformedProperties: [String: RetroluxReflector.ValueTransformer] = [
